    ...
    if (total) {
      ...
      if (category) {
        mailOptions = {
          ...
          subject: 'Estimate Recieved ✔', // Subject line
        ...
        mailOptions = {
          ...
          html: `<p style="font-size:16px">From : ${name}</p>
                 ...
                 <p style="font-size:16px">Phone : ${phone}</p>
                 <p style="font-size:16px">Message : ${message}</p>
                 <p style="font-size:16px">Platform : ${platforms.join(',')}</p>
                 <p style="font-size:16px">Features : ${features.join(',')}</p>
          ...
          transporter.sendMail(
            {
              ...
              subject: 'We have recieved Your Message ✔', // Subject line
              text: `Hello ${name}! Thanks for Contacting us! We have recieved your Message`, // plain text body
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                <tr>
                                                  ...
                                                  >
                                                    Thanks for placing your estimate request! We'll go over the details and get back to you soon as possible.
                                                  </td>
                                                </tr>
                                              </table>
                                            </td>
