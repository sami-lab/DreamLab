...
//import sections from '../src/revolutionData'

import technology from '../src/animations/technologyAnimation/data.json';
...
const Revolution = (props) => {
  ...
  return (
    <Grid container direction="column">
      <Head>
        <title key="title">
          The Revolution - Cutting-Edge Software | DreamLab Development
        </title>
        <meta
          name="description"
          key="description"
          content="Visionary insights, coupled with cutting-edge technology, is a recipe for recipe for revolution. Get a free online estimate instantly!"
        />
        <meta
          property="og:title"
          content="Bringing West Coast Technology to the MiddleEast | The Revolution"
          key="og:title"
        />
        <meta property="og:url" content="/revolution" key="og:url" />
        <link rel="canonical" key="canonical" href="/revolution" />
      </Head>
      <Grid item style={{ marginTop: '2em' }} className={classes.rowContainer}>
        <Typography
          variant="h1"
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              f or developing new pieces of software, while also lowering the
